...
- Percent aligned (e.g., Smith-Waterman local alignment)
- Global alignment (word frequencies) or topic proportions ($\sum (\theta_d - \theta_{d'})$)

## Measuring change across versions:
- Percent new words, n-grams, sentences
- Percent unaligned (e.g., Smith-Waterman local alignment)
- Change in global alignment (word frequencies) or topic proportions ($\sum (\theta_d - \theta_{d'})$)
