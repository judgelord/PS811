...
ggplot( aes(x = height, y = birth_year) ) + 
  ...
  geom_text(aes(label = ifelse(birth_year > 750, name, NA)), hjust = 0)
```
...
```{r lm-drop-outlier2, fig.width=8, fig.height = 8}
...
```{r lm-by-group, fig.width=8, fig.height = 8}
starwars %>%
...
```{r starwars-height, fig.width=10, fig.height=8}
...
ggplot() +  
  ...
  geom_point(aes(x=-89.4012, y=43.0731), size=3, color = "Red") +
